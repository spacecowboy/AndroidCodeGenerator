...
import com.example.appname.database.DatabaseHandler;
import com.example.appname.database.PersonItem;
...
public class PersonDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = DatabaseHandler.getInstance(getActivity()).getPersonItem(getArguments().getLong(ARG_ITEM_ID));
        }
    }
